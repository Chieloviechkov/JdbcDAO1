...
public abstract class AbstractDAO<T> {
    ...
    public List<T> getAll(Class<T> cls, String... columnsToShow) {
        ...
        try {
            try (Statement st = conn.createStatement()) {
                ...
                if (columnsToShow.length == 0) {
                    ...
                    selectColumns = String.join(",", columnsToShow);
                }

                try (ResultSet rs = st.executeQuery("SELECT " + selectColumns + " FROM " + table)) {
